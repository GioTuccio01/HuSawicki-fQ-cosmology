...
# Scan su α e z
alphas = [-0.3, -0.154, -0.05, 0.0, 0.05, 0.154, 0.3]
...
print()
print("Conclusioni:")
print("  - A z → 10^9 (BBN), ΔH²/H² è dell'ordine di α/x² = α/(6 Ω_r (1+z)^4)^2")
print("    che per α ~ 0.15 e z = 3e9 dà ~ 10^(-74). Totalmente trascurabile.")
print("  - BBN è salvo per qualsiasi valore di α nel range fisico.")
print("  - La struttura UV-soffice del modello (correzione ∼ α/x per x→∞) è la ragione.")
...
print(f"  H² / H0² ≈ Ω_r (1+z)^4 ≈ {H2_over_H02:.3e}")
print(f"  x_BBN = 6 H² / μ² ≈ {x_bbn:.3e}  (μ = H0 per η=√6)")
print(f"  |ΔH²/H²| ~ α / x² ~ {0.154/x_bbn**2:.3e}  (per α=0.154)")
print(f"  Il vincolo BBN |ΔH²/H²| < 0.1 è soddisfatto di ~74 ordini di grandezza!")
